...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Soustraction = New System.Windows.Forms.Button()
        ...
        Me.Soustraction.Text = "-"
        Me.Soustraction.UseVisualStyleBackColor = True
        '
        'Addition
        '
        ...
        Me.Egal.TabIndex = 15
        Me.Egal.Text = "="
        Me.Egal.UseVisualStyleBackColor = True
        '
        'Virgule
        '
        ...
        Me.Controls.Add(Me.Soustraction)
    ...
    Friend WithEvents Soustraction As Button
    Friend WithEvents Addition As Button
    Friend WithEvents Egal As Button
